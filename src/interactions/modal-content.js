...
export function therapyModalContent(therapyKey, problemKey) {
  ...
  return `
    ...
    <div class="modal-grid">
      <div class="modal-metric"><span>改善率</span><strong>${metrics.improvementRate}%</strong></div>
      <div class="modal-metric"><span>情绪效价提升</span><strong>d ≈ ${metrics.effectSize}</strong></div>
      <div class="modal-metric"><span>满意度</span><strong>${metrics.satisfaction}%</strong></div>
    </div>
